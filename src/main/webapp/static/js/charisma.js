$(document).ready(function(){
	...
	var cookieName = 'org.springframework.web.servlet.theme.CookieThemeResolver.THEME';
	var current_theme = $.cookie(cookieName, { path: "/" })==null ? 'cerulean' :$.cookie(cookieName, { path: "/" });
	//alert("cookie theme:"+current_theme);
	...
	$('#themes a').click(function(e){
		...
		$.cookie(cookieName,current_theme,{expires:365,path: "/" });
		switch_theme(current_theme);
	...
	{
		$('#bs-css').attr('href','/management/static/css/bootstrap-'+theme_name+'.css');
	}
