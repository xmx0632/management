 ...
 * @author calvin
 */
public abstract class IgnorePrefixReverseEngineeringStrategy extends
		DelegatingReverseEngineeringStrategy {

	public IgnorePrefixReverseEngineeringStrategy(
	...
	protected String ignorePrefix(String delegateResult) {
		...
		String className = delegateResult.substring(lastDotIndex
				+ getPrefixLength() + 1);
